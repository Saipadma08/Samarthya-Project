...
const AnimationText = () => {
  return (
    <div>
      <div className='flex flex-col w-full lg:w-[80%] gap-13 px-5 text-2xl mt-10 font-bold'>
            <motion.div
            ...
            >
                <div className='text-white bg-cyan-600 py-3 px-6 rounded-full'>
